...
return [
    ...
    'description' => 'Enterprise Multi-Tenant Double-Entry Accounting & ERP Engine API documentation.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Send your OAuth2 token via the Authorization header: `Bearer {YOUR_TOKEN}`.',
    ],
